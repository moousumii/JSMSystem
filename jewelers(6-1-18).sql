...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 06, 2018 at 11:02 AM
...
DROP TABLE IF EXISTS `cash_account_info`;
...
DROP TABLE IF EXISTS `cash_payment_info`;
...
DROP TABLE IF EXISTS `cash_transfer_details`;
...
(1, '', 'Mr. Customer ', '01718508746', '2017-09-08', 'testing', 1, 1, -2020, 'no note . this field is only for kanthi ....', '2017-09-08 21:51:30', 9),
...
DROP TABLE IF EXISTS `debit_note_info`;
...
DROP TABLE IF EXISTS `expair_date`;
...
DROP TABLE IF EXISTS `expense_field_info`;
...
(1, 'new product', '', 13, 0, 'product description 1 ', 'kg', 0, 20000, 'note for product. 1', 1, 0, 2, 1, 0, '2017-09-09 01:42:07', '2017-09-23 21:00:05', 9, 0),
(3, 'lafarge Surma Cement', '', 7497, 0, 'Lafarge Cement', 'Sack', 0, 47681687, 'Lafarge Cement', 2, 0, 4, 1, 0, '2017-09-18 15:18:44', '2017-09-23 21:00:05', 9, 0),
(4, 'BSRM Rod', '', 998, 0, 'BSRM Rod', 'Ton', 0, 5445, 'BSRM Rod', 3, 0, 2, 1, 0, '2017-09-18 15:26:53', '2017-09-22 16:11:45', 9, 0);
...
DROP TABLE IF EXISTS `product_status_info`;
...
DROP TABLE IF EXISTS `product_update_info`;
...
DROP TABLE IF EXISTS `pyment_info`;
...
DROP TABLE IF EXISTS `quality_price_info`;
...
(2, '21/21 CARAT', 0, 1),
(3, '18/18 CARAT', 0, 1),
(4, 'TRADITIONAL METHOD', 0, 1),
(5, '21/21 CARAT SILVER (CADMIUM)', 0, 1);
...
DROP TABLE IF EXISTS `quick_sale_details`;
...
DROP TABLE IF EXISTS `sale_payment_info`;
...
DROP TABLE IF EXISTS `transection_info`;
...
DROP TABLE IF EXISTS `transection_type_info`;
...
--
ALTER TABLE `transection_info`
  MODIFY `transectionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
