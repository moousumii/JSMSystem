<?php include('header.php') ?>
	<div class="row">
		<div class="col-md-12">
			<h3 class="page-header">Edit Manager</h3>
		</div>
	</div>
	<?php 
		echo form_open('admin/updateManager/'.$infos->adminID);
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<a href="<?php echo base_url("admin/allManager"); ?>" type="button" class="btn btn-danger"><i class="fa fa-"></i> Back</a>	
						</div>
						<?php echo form_close(); ?>
					</div>					
				</div>
