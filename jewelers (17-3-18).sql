...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 17, 2018 at 12:19 AM
...
(14, '', 'Mr. Kanthi Lal Baidya', '01554789652', '2018-03-01', '', 1, 1, 150000, 'daria  para, sylhet', 'he loves to write notes', '2018-03-17 03:58:58', 10),
(15, '', 'Mr. Mahfuz Mafi', '01675896542', '2018-03-14', 'kanthi lal baidya', 1, 1, 7000, 'Mirzajanggal, Sylhet', 'vary lazy person', '2018-03-17 04:00:26', 10);
...
(50, 'Neckless ', '121050', 1, 250, '', 'g', 100, 0, '', 12, 1, 0, 1, 0, '2018-03-17 03:55:36', '2018-03-16 21:55:36', 0, 0),
(51, 'Ring', '131051', 0, 67, '', 'g', 60, 0, '', 13, 1, 1, 1, 0, '2018-03-17 03:55:59', '2018-03-16 22:05:15', 0, 0),
(52, 'Ring', '131052', 1, 20, '', 'g', 100, 0, '', 13, 1, 0, 1, 0, '2018-03-17 03:56:20', '2018-03-16 21:56:20', 0, 0),
(53, 'Payel ', '141053', 1, 20, '', 'g', 40, 0, '', 14, 5, 0, 1, 0, '2018-03-17 03:56:48', '2018-03-16 21:56:48', 0, 0);
...
(33, 2000, 11, 33, '', 15, 10, '2018-03-16 23:06:05', 0);
...
(3, 'Return Product', 'viewExchangeDetails'),
...
(12, 'Paid Payment', 'viewReceivedPayment');
...
--
ALTER TABLE `bill_info`
  MODIFY `billInfoId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `sale_details`
  MODIFY `saleDetailsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `transection_info`
  MODIFY `transectionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
